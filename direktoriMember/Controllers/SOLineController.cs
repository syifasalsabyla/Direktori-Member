...
using direktoriMember.Data;
using direktoriMember.Models;

namespace direktoriMember.Controllers
{
    public class SOLineController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SOLineID,Quantity,ProdukID,SOHeaderID")] SOLine sOLine)
        {
            ...
            ViewData["ProdukID"] = new SelectList(_context.Produk, "ProdukID", "ProdukID", sOLine.ProdukID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SOLineID,Quantity,ProdukID,SOHeaderID")] SOLine sOLine)
        {
