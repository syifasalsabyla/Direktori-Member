...
using direktoriMember.Models.VM;
...
namespace direktoriMember.Controllers
{
    public class SOHeaderController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SOHeaderID,Tanggal,NamaMember,MemberID")] SOHeader sOHeader)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SOHeaderID,Tanggal,NamaMember,MemberID")] SOHeader sOHeader)
        {
